...
def insert_dhcp_clients(dhcp_clients_list:list, timestamp:float, max_history:int=DEFAULT_DHCP_MAX_HISTORY, table_name:str=TABLE_DHCP_CLIENTS):
    ...
    Args:
        dhcp_clients_list (list): _description_
        timestamp (float): _description_
        max_history (int, optional): _description_. Defaults to DEFAULT_DHCP_MAX_HISTORY.
        table_name (str, optional): _description_. Defaults to TABLE_DHCP_CLIENTS.
    """
