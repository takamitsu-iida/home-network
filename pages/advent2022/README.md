...
ユニキャストの中でも先頭１オクテットが2か6かAかEで終わってたら、それはプライベートMACアドレスなのでandroidやiOSといったデバイスだと考えていいでしょう。
...
同じスマホなのに接続するSSIDで違うMACアドレスの装置としてネットワークで扱われるので、ネットワークを管理する側の目線ではあまり好ましいことではありません。

同じSSIDで802.11aと11gの両方の電波を吹くべきですね。
